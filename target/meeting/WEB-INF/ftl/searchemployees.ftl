        ...
        <div>
            ...
            <div class="pager-header">
                <div class="header-info">
                    ...
                    分成<span class="info-number">${pageNumber}</span>页显示，
                    当前第<span class="info-number">${page}</span>页
                </div>
                <div class="header-nav">
                    <a type="button" class="clickbutton" href="/admin/searchemployees?status=${employee.status}&page=1&employeeName=${employee.employeeName!''}&username=${employee.username!''}">首页</a>
                    <a type="button" class="clickbutton"
                            <#if page!=1>
                                href="/admin/searchemployees?status=${employee.status}&page=${page-1}&employeeName=${employee.employeeName!''}&username=${employee.username!''}"
                            </#if>
                    >上页</a>
                    <a type="button" class="clickbutton"
                            <#if page!=pageNumber>
                    ...
                    >下页</a>
                    <a type="button" class="clickbutton"
                       href="/admin/searchemployees?status=${employee.status}&page=${pageNumber}&employeeName=${employee.employeeName!''}&username=${employee.username!''}">末页</a>
            ...
            <#if emps??>
                <#list emps as emp>
                    <tr>
                        ...
                        <td>${emp.email}</td>
                        <td>
                            <a class="clickbutton" href="/admin/closeemp?id=${emp.employeeId}">关闭账号</a>
                        </td>
                    </tr>
                </#list>
            </#if>
